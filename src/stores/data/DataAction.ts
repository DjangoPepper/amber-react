...
export default class DataAction {
  // Définissez les types d'action comme des constantes
 ...
 public static CHANGE_DESTINATION_COLOR = 'DataAction.CHANGE_DESTINATION_COLOR';

  // Définissez les créateurs d'actions comme des fonctions
  ...
  // Nouvelle action pour changer la couleur de la destination
  public static changeDestinationColor(destinationName: string, newColor: string): AnyAction {
    return {
      type: DataAction.CHANGE_DESTINATION_COLOR,
      destinationName,
      newColor,
    };
  }
